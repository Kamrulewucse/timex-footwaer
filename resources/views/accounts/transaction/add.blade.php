        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('transaction.add') }}">
                    ...
                    <div class="card-body">
                        <div class="form-group row {{ $errors->has('sale_type_status') ? 'has-error' :'' }}">
                            <label class="col-sm-2 col-form-label">Sale Type *</label>

                            <div class="col-sm-10">
                                <select class="form-control select2" name="sale_type_status" id="sale_type_status">
                                    <option value="">Select Type</option>
                                    <option value="1" {{ old('sale_type_status') == '1' ? 'selected' : '' }}> Retail Sale </option>
                                    <option value="2" {{ old('sale_type_status') == '2' ? 'selected' : '' }}> Whole Sale </option>
                                </select>

                                @error('sale_type_status')
...
{{--                            <label class="col-sm-2 col-form-label">Account Head Sub Type *</label>--}}
...
{{--                        </div>--}}
                        ...
                        <div id="bank-info">
                            ...
                            <div class="form-group row {{ $errors->has('cheque_image') ? 'has-error' :'' }}">
                                <label class="col-sm-2 col-form-label">Cheque Image</label>
