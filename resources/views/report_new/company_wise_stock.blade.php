    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('report_company_wise_stock') }}">
                        <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <select class="form-control select2" name="company" required>
                                        ...
                                        @foreach($suppliers as $supplier)
                                            <option value="{{ $supplier->id }}" {{ request()->get('company') == $supplier->id ? 'selected' : '' }}>{{ $supplier->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div id="prinarea">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                    ...
                                    <h4 style="margin-bottom: 0px;margin-top: 0px;padding: 0">Company Wise Stock Report</h4>
                            </div>
                        </div>
                        ...
                        <table id="table" class="table table-bordered">
                            ...
                            @foreach($inventories as $inventory)
                                <tr>
                                    ...
                                    <td class="text-right">Tk  {{number_format($inventory->quantity*$inventory->avg_unit_price,2)}}</td>
                                </tr>
                            ...
                            <tfoot>
                            <tr>
                                <th colspan="3" style="border-right: 1px solid #fff !important;"></th>
