    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('report_item_wise_stock') }}">
                        <div class="row">
...
{{--                                <th>Warehouse</th>--}}
                                ...
                                <th class="text-center">Group Wise Stock (PCS)</th>
                                <th class="text-center">Brand Wise Stock (PCS)</th>
...
{{--                                    <td>{{$inventory->warehouse->name??''}}</td>--}}
                            ...
                            <tfoot>
                            <tr>
                                <th colspan="4" style="border-right: 1px solid #fff !important;"></th>
