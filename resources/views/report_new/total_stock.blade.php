    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('report_total_stock') }}">
                        <div class="row">
                    ...
                    <div id="prinarea">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                    ...
                                    <h4 style="margin-bottom: 0px;margin-top: 0px;padding: 0">Total Stock Report</h4>
                            </div>
                        </div>
                        ...
                        <table id="table" class="table table-bordered">
                            ...
                            <tfoot>
                            <tr>
                                <th style="border-right: 1px solid #fff !important;"></th>
