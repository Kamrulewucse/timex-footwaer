                    ...
                    <div class="tab-pane" id="salary">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>House Rent</th>
                                    <td>Tk {{ $employee->house_rent }}</td>
                                </tr>
                                <tr>
                                    <th>Travel</th>
                                    <td>Tk {{ $employee->travel }}</td>
                                </tr>
                                <tr>
                                    <th>Medical</th>
                                    <td>Tk {{ $employee->medical }}</td>
                                </tr>
                                <tr>
                                    <th>Tax</th>
                                    <td>Tk {{ $employee->tax }}</td>
                                </tr>
                                <tr>
                                    <th>Others Deduct</th>
                                    <td>Tk {{ $employee->others_deduct }}</td>
                                </tr>
                                <tr>
                                    <th>Gross Salary</th>
                                ...
                                <table class="table no-margin">
                                    ...
                                    @foreach($employee->salaryChangeLog as $log)
                                        <tr>
                                            ...
                                            <td>Tk {{ $log->basic_salary }}</td>
                                            <td>Tk {{ $log->house_rent }}</td>
                                            <td>Tk {{ $log->travel }}</td>
                                            <td>Tk {{ $log->medical }}</td>
                                            <td>Tk {{ $log->tax }}</td>
                                            <td>Tk {{ $log->others_deduct }}</td>
                                            <td>Tk {{ $log->gross_salary }}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
