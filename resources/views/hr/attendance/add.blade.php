                    ...
                    <form action="{{route('employee.attendance')}}" method="post">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                <input id="attend_date" value="{{ empty(old('attend_date')) ? ($errors->has('attend_date') ? '' : date('Y-m-d')) : old('attend_date') }}" name="attend_date" type="text" class="form-control" autocomplete="off">
