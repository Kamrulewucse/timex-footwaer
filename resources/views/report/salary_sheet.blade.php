                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                @foreach($salaries as $salary)
                                    <tr>
                                        ...
                                        <td class="text-center">Tk  {{number_format($salary->basic_salary,2)}}</td>
                                        <td class="text-center">Tk  {{number_format($salary->house_rent,2)}}</td>
                                        <td class="text-center">Tk  {{number_format($salary->travel,2)}}</td>
                                        <td class="text-center">Tk  {{number_format($salary->medical,2)}}</td>
                                        <td class="text-center">Tk  {{number_format($salary->gross_salary,2)}}</td>
                                        <td class="text-center">Tk  {{number_format($salary->absent_deduct,2)}}</td>
                                        <td class="text-center">Tk  {{number_format($salary->others_deduct,2)}}</td>
                                        <td class="text-center">Tk  {{number_format($salary->gross_salary-$salary->others_deduct-$salary->absent_deduct,2)}}</td>
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Tk  {{number_format($salaries->sum('basic_salary'),2)}}</th>
                                    <th class="text-center">Tk  {{number_format($salaries->sum('house_rent'),2)}}</th>
                                    <th class="text-center">Tk  {{number_format($salaries->sum('travel'),2)}}</th>
                                    <th class="text-center">Tk  {{number_format($salaries->sum('medical'),2)}}</th>
                                    <th class="text-center">Tk  {{number_format($salaries->sum('gross_salary'),2)}}</th>
                                    <th class="text-center">Tk  {{number_format($salaries->sum('absent_deduct'),2)}}</th>
                                    <th class="text-center">Tk  {{number_format($salaries->sum('others_deduct'),2)}}</th>
                                    <th class="text-center">Tk  {{number_format($salaries->sum('gross_salary')-$salaries->sum('absent_deduct')-$salaries->sum('others_deduct'),2)}}</th>
