                        ...
                        <div class="adv-table" id="prinarea">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    <h4 style="margin-bottom: 0px;margin-top: 0px;padding: 0">Cashbook</h4>
                                </div>
                            </div>
                            ...
                            <div class="adv-table" id="prinarea">
                                <h4 class="text-center"><b>Profit & Loss Retail Sale</b></h4>
                                @if($total_retail_incomes)
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-header with-border">
                                                ...
                                                <div class="card-body">
                                                    @if(($total_retail_incomes->sum('amount')) >= $total_retail_expenses->sum('amount'))
                                                        <strong>Total Revenue : </strong> Tk  {{ number_format($total_retail_incomes->sum('amount'),2)}}<br>
                                                        <strong>Total Expense : </strong> Tk  {{ number_format($total_retail_expenses->sum('amount'),2) }}<br>
                                                        <strong>Net Profit : </strong> Tk  {{ number_format(($total_retail_incomes->sum('amount')) - $total_retail_expenses->sum('amount'), 2) }}
                                                    @else
                                                        <strong>Loss: </strong> {{ number_format($total_retail_expenses->sum('amount') - ($total_retail_incomes->sum('amount')), 2) }}
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <table class="table table-bordered " style="margin-bottom: 0px;">
                                        ...
                                        <table class="table table-bordered" style="width:50%; float:left">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">Tk  {{ number_format($total_retail_incomes->sum('amount'),2)}}</th>
                                            </tr>
                                            <tr>
                                            ...
                                            @foreach($total_retail_incomes as $income)
                                                <tr>
                                            ...
                                            <?php
                                            $incomesCount = count($total_retail_incomes);
                                            $expensesCount = count($total_retail_expenses);
                                            ...
                                            $maxCount += 2;
                                            ?>
                                            @for($i=count($total_retail_incomes); $i<$maxCount; $i++)
                                                <tr>
                                                    <td><br><br></td>
                                                    <td></td>
                                                    {{--                                            <td></td>--}}
                                        ...
                                        <table id="table" class="table table-bordered table-striped" style="width:50%; float:left">
                                            ...
                                            <tr>
                                                <th class="text-center" colspan="2">Total</th>
                                                <th class="text-center">Tk  {{ number_format($total_retail_expenses->sum('amount'),2) }}</th>
                                            </tr>
                                            <tr>
                                                <th class="text-center">Date</th>
                                                <th class="text-center">Particular</th>
                                            ...
                                            @foreach($total_retail_expenses as $expense)
                                                <tr>
                                            ...
                                            @for($i=count($total_retail_expenses); $i<$maxCount; $i++)
                                                <tr>
                                                    <td><br><br></td>
                                                    <td></td>
                                                    {{--                                            <td></td>--}}
                            ...
                            <div class="adv-table" id="prinarea">
                                <h4 class="text-center"><b>Profit & Loss WholeSale</b></h4>
                                @if($total_whole_incomes)
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-header with-border">
                                                ...
                                                <div class="card-body">
                                                    @if(($total_whole_incomes->sum('amount')) >= $total_whole_expenses->sum('amount'))
                                                        <strong>Total Revenue : </strong> Tk  {{ number_format($total_whole_incomes->sum('amount'),2)}}<br>
                                                        <strong>Total Expense : </strong> Tk  {{ number_format($total_whole_expenses->sum('amount'),2) }}<br>
                                                        <strong>Net Profit : </strong> Tk  {{ number_format(($total_whole_incomes->sum('amount')) - $total_whole_expenses->sum('amount'), 2) }}
                                                    @else
                                                        <strong>Loss: </strong> {{ number_format($total_whole_expenses->sum('amount') - ($total_whole_incomes->sum('amount')), 2) }}
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div style="clear: both; width: 100% !important" class="table-responsive">
                                    <table class="table table-bordered " style="margin-bottom: 0px;">
                                        ...
                                        <table class="table table-bordered" style="width:50%; float:left">
                                            ...
                                            <tr>
                                                <th class="text-center" colspan="2">Total</th>
                                                <th class="text-center">Tk  {{ number_format($total_whole_incomes->sum('amount'),2)}}</th>
                                            </tr>
                                            <tr>
                                                <th class="text-center">Date</th>
                                                <th class="text-center">Particular</th>
                                            ...
                                            @foreach($total_whole_incomes as $income)
                                                <tr>
                                                    <td class="text-center">{{ $income->date->format('j F, Y') }}</td>
                                                    <td>{{ $income->particular }} ({{$income->companyBranch->name ?? ''}})</td>
                                                    {{--                                            <td class="text-center">{{ $income->note }}</td>--}}
                                            ...
                                            <?php
                                            $incomesCount = count($total_whole_incomes);
                                            $expensesCount = count($total_whole_expenses);
                                            ...
                                            $maxCount += 2;
                                            ?>
                                            @for($i=count($total_whole_incomes); $i<$maxCount; $i++)
                                                <tr>
                                                    <td><br><br></td>
                                                    <td></td>
                                                    {{--                                            <td></td>--}}
                                        ...
                                        <table id="table" class="table table-bordered table-striped" style="width:50%; float:left">
                                            ...
                                            <tr>
                                                <th class="text-center" colspan="2">Total</th>
                                                <th class="text-center">Tk  {{ number_format($total_whole_expenses->sum('amount'),2) }}</th>
                                            </tr>
                                            <tr>
                                                <th class="text-center">Date</th>
                                                <th class="text-center">Particular</th>
                                            ...
                                            @foreach($total_whole_expenses as $expense)
                                                <tr>
                                                    <td class="text-center">{{ $expense->date->format('j F, Y') }}</td>
                                                    <td>{{ $expense->particular }} ({{$expense->companyBranch->name ?? ''}})</td>
                                                    {{--                                            <td class="text-center">{{ $expense->note }}</td>--}}
                                            ...
                                            @for($i=count($total_whole_expenses); $i<$maxCount; $i++)
                                                <tr>
                                                    <td><br><br></td>
                                                    <td></td>
                                                    {{--                                            <td></td>--}}
