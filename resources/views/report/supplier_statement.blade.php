                         ...
                         <table id="table" class="table table-bordered table-striped">
                             ...
                             @foreach($suppliers as $supplier)
                                 <tr>
                                     ...
                                     <td >{{$supplier->name}}</td>
                                     <td class="text-center">Tk  {{number_format($supplier->total,2)}}</td>
                                     <td class="text-center">Tk  {{number_format($supplier->opening_due,2)}}</td>
                                     <td class="text-center">Tk  {{number_format($supplier->paid,2)}}</td>
                                     <td class="text-center">Tk  {{number_format($supplier->due,2)}}</td>
                                 </tr>
                             @endforeach
                             ...
                             <tr>
                                 ...
                                 <th class="text-center">Tk  {{number_format($suppliers->sum('total'),2)}}</th>
                                 <th class="text-center">Tk  {{number_format($suppliers->sum('opening_due'),2)}}</th>
                                 <th class="text-center">Tk  {{number_format($suppliers->sum('paid'),2)}}</th>
                                 <th class="text-center">Tk  {{number_format($suppliers->sum('due'),2)}}</th>
                             </tr>
                             </tfoot>
