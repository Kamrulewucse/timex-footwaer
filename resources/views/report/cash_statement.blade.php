                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($result as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">Tk  {{ number_format((double)$item['credit'],2) }}</td>
                                        <td class="text-center">Tk  {{ number_format((double)$item['debit'],2) }}</td>

                                        <td class="text-center">Tk  {{ number_format((double)$item['balance'],2) }}</td>
                                    </tr>
                                @endforeach
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Tk  {{ number_format((double)$metaData['total_credit'],2) }}</th>
                                    <th class="text-center">Tk  {{ number_format((double)$metaData['total_debit'],2) }}</th>

                                    <th class="text-center">Tk  {{ number_format((double)$item['balance'] ,2)}}</th>
                                </tr>
                                </tfoot>
                            </table>
                            </div>
