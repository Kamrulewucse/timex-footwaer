    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('customer.edit', ['customer' => $customer->id,'type'=>request()->get('type')]) }}">
                    @csrf
...
{{--                                            <option value="{{ $branch->id }}" {{ $customer->company_branch_id==$branch->id?'selected':'' }}>{{ $branch->name }}</option>--}}
{{--                                        @endforeach--}}
{{--                                    </select>--}}
{{--                                    @error('branch')--}}
{{--                                    <span class="help-block">{{ $message }}</span>--}}
