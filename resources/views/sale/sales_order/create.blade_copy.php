...
{{--                            </div>--}}
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div card="card-header with-border">
                                    ...
                                    <tbody id="customerPreviousOrder">
                                        @foreach($sale_orders as $sale_order)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('sale_receipt.details', ['order' => $sale_order->id]) }}" target="_blank" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a> </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                                ...
                                if ('{{Auth::user()->company_branch_id == 0}}'){
                                    ...
                                    if (response.data.quantity > 6){
                                        var html = '<tr class="product-item"> ' +
                                            ...
                                            '<div class="form-group"> <input type="text" readonly class="form-control warehouse" name="warehouse[]" value="'+response.data.warehouse.name+'"> </div></td><td> <div class="form-group"> ' +
                                            '<input type="text" readonly class="form-control product_stock" name="product_stock[]" value="'+response.data.quantity+'"> </div></td><td> <div class="form-group"> <input type="number" class="form-control quantity" name="quantity[]" max="'+response.data.quantity+'" value="6"> </div></td><td>' +
                                            '<div class="form-group"> <input type="text" readonly class="form-control unit_price" name="unit_price[]" value="'+response.data.selling_price+'"> </div></td><td class="total-cost">Tk 0.00</td><td class="text-center"> <a role="button" class="btn btn-danger btn-sm btn-remove">X</a> </td></tr>';
                                        $('#product-container').append(html);
                                    }
                                    else{
                                        var html = '<tr class="product-item"> ' +
