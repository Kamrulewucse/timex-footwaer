...
<div class="container-fluid">
    <div class="row" style="border: 1px solid black;margin-bottom: 5px;">
        <div class="col-xs-1 text-center" style="height: 30px;">
            <div>
                <p style="padding-top: 3px;">নাম</p>
            </div>
        </div>
        ...
        <div class="col-xs-1 text-center" style="border-left: 1px solid black;height: 30px;">
            <div>
                <p style="padding-top: 3px;">তারিখ</p>
            </div>
        </div>
        <div class="col-xs-5" style="height: 30px;">
            <div>
    ...
    <div class="row" style="border: 1px solid black;margin-bottom: 5px;">
        <div class="col-xs-2 text-center" style="height: 30px;">
            <div>
                <p style="padding-top: 3px;">ঠিকানা</p>
            </div>
        </div>
        ...
        <div class="col-xs-2 text-center" style="height: 30px;border-left: 1px solid black;">
            <div>
                <p style="padding-top: 3px;">মোবাইল</p>
            </div>
        </div>
        <div class="col-xs-4" style="height: 30px;">
            <div>
...
@if(count($order->products) > 0)
    ...
    <table class="table table-bordered product-table pt-4" style="margin-top: 5px; margin-bottom: 1px !important; font-size: 12px">
        <thead>
        <tr>
            <th class="text-center" style="border: 1px solid black !important;"> সংখ্যা </th>
            <th style="border: 1px solid black !important;"> মালের বিবরণ </th>
            <th style="border: 1px solid black !important;"> জোড়া </th>
            <th class="text-right" style="border: 1px solid black !important;">দর</th>
            <th class="text-right" style="border: 1px solid black !important;">টাকা</th>
        </tr>
        </thead>
        <?php
        $subTotal = 0;
