            ...
            <div class="card">
                <div class="card-body table-responsive">
                    <table id="table" class="table table-bordered table-striped">
                        <thead>
                        <tr>
                            <th class="btn btn-danger">Trash Date</th>
                            <th>Payment Date</th>
                            <th>Customer</th>
                            <th>Address</th>
                            <th>Phone</th>
...
{{--                            <th>Action</th>--}}
                        ...
                        <tbody>
                        @foreach ($trashPayments as $payment)
                            <tr>
                                <td class="btn btn-danger">{{ $payment->deleted_at->format('Y-m-d') }}</td>
